...
import main_app.custom_validator
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, validators=[main_app.custom_validator.ValidateName('Name can only contain letters and spaces')])),
